	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				...
				<a href="<?php echo $base_url.Request::segment(1).DS.Request::segment(2) . '?do=insert' ?>" class="btn btn-primary btn-sm btncreate"><i class="fa fa-plus" aria-hidden="true"></i> {{ $capabilitylang['add_new'] }}</a><br/><br/>
