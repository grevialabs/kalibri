...
$article_attribute_value_model = new ArticleAttributeValueModel();
$general_model = new GeneralModel();

$getorder_allowed_list = $article_attribute_value_model->getorder_allowed_list();
...
$api_url = env('API_URL').'article_attribute_value/get_list';
$api_method = 'get';
// $api_header['debug'] = 1;
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-body">
				...
				<a href="<?php echo $base_url.Request::segment(1).DS.Request::segment(2) . '?do=insert' ?>" class="btn btn-primary btn-sm btninsert"><i class="fa fa-plus" aria-hidden="true"></i> {{ $article_attribute_value_lang['add_new'] }}</a><br/><br/>
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered" id="table_company">
							...
							if (! empty($listdata)) 
							{
								...
								{
									$i++;
									$id = $rs['article_attribute_value_id'];
									$idcol = 'article_attribute_value_id';
							?>
