					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered" id="table_reason">
							<tr class="b">
								...
								<td width=""><a class="{{ $arrsort['article_id']['class'] }}" title="{{ $arrsort['article_id']['title'] }}" href="{{ $arrsort['article_id']['url'] }}">{{ $reason_type_lang['article_id'] }} {!! $arrsort['article_id']['icon'] !!}</a></td>
