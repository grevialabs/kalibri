			...
			<div class="card-body">
				...
				<form method="post" action="{{ $form_url }}" class="form-horizontal">
					...
					<div class="form-group row">
						...
						<div class="col-lg-7 col-lg-offset-3 col-md-9 col-sm-12">
							<input type="text" data-toggle="{{ $reason_type_mapping_lang['reason_type_id'] }}" title="{{ $reason_type_mapping_lang['reason_type_id'] }}" class="form-control" id="reason_type_id" name="reason_type_id" placeholder="{{ $reason_type_mapping_lang['reason_type_id'] }}" required="" data-original-title="" />
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-7 col-lg-offset-3 col-md-9 col-sm-12">
							<input type="text" data-toggle="{{ $reason_type_mapping_lang['reason_id'] }}" title="{{ $reason_type_mapping_lang['reason_id'] }}" class="form-control" id="reason_id" name="reason_id" placeholder="{{ $reason_type_mapping_lang['reason_id'] }}" required="" data-original-title="" />
						</div>
					</div>
