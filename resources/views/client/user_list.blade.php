					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered" id="table_user">
							<tr class="b">
								...
								<td width="180px"><a class="{{ $arrsort['firstname']['class'] }}" title="{{ $arrsort['firstname']['title'] }}" href="{{ $arrsort['firstname']['url'] }}">userName {!! $arrsort['firstname']['icon'] !!}</a></td>
								<td><a class="{{ $arrsort['firstname']['class'] }}" title="{{ $arrsort['firstname']['title'] }}" href="{{ $arrsort['firstname']['url'] }}">userAddress {!! $arrsort['firstname']['icon'] !!}</a></td>
								<td width="180px"><a class="{{ $arrsort['division']['class'] }}" title="{{ $arrsort['division']['title'] }}" href="{{ $arrsort['division']['url'] }}">division {!! $arrsort['division']['icon'] !!}</a></td>
								<td width="180px"><a class="{{ $arrsort['email']['class'] }}" title="{{ $arrsort['email']['title'] }}" href="{{ $arrsort['email']['url'] }}">userPIC {!! $arrsort['email']['icon'] !!}</a></td>
